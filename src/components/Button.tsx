...
export default function Button({ variant = 'primary', className = '', children, ...props }: ButtonProps) {
    const baseStyles = "inline-flex items-center justify-center px-8 py-3 rounded-sm font-medium transition-colors duration-200 cursor-pointer text-base sm:text-lg";
