...
test('rejects unsupported work item fields and malformed dates', () => {
  ...
  assert.deepEqual(parseProjectWorkItem({ projectId: '123e4567-e89b-42d3-a456-426614174000', kind: 'task', title: 'Call client', dueOn: ' 2026-07-23junk ' }), { valid: false, error: 'Choose a valid due date.' });
