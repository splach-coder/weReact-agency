...
description: >
  ...
  Use this skill for cinematic or motion-rich web design tasks: landing pages, product sites, hero sections,
  ...
  Covers 45+ techniques across 8 categories. Always inspects, judges, and plans assets before coding. Use for cinematic, premium, scroll-driven, or motion-rich web design tasks; for ordinary UI polish, ask whether this level of motion is desired before applying it.
license: MIT
metadata:
  version: 1.0.0
  author: Abbas Mir
...
Do not hardcode black, dark, luxury, Apple-style, Awwwards-style, or any single aesthetic unless the user asks for it or the project context clearly establishes it.

Before designing, identify or ask for these inputs when missing:
- Brand palette or preferred colors
- Light, dark, mixed, or system-adaptive theme
- Mood and market position: playful, premium, editorial, bold, calm, technical, agency, product-led, etc.
- Motion tone: subtle, cinematic, energetic, minimal, or accessibility-first
- Storytelling intensity: simple section transitions, guided scrollytelling, product journey, or full cinematic sequence

If the user does not specify visual direction, present 2-3 style options and ask them to choose. Keep the animation, storytelling, depth, and asset-planning strengths of this skill, but adapt the visual language to the brand instead of defaulting to black or dark design.

## Your Mindset

Every website you build with this skill should feel intentional, layered, and alive. The reference point can be cinematic product storytelling, editorial motion, playful brand worlds, calm premium minimalism, or another direction chosen by the user. Even a simple landing page can have:
...
**Never build a flat, static page when this skill is active, but scale the motion intensity to the user's brand, audience, and accessibility needs.**
...
2. What visual direction? Ask for theme (light/dark/mixed/adaptive), brand palette, mood, motion intensity, and storytelling style. Do not assume black or a dark design.
3. How many sections? (hero only, full page, specific section?)

### B. Confirm visual direction before design choices

If the user has not specified style direction, ask concise questions before choosing colors, themes, or overall aesthetic. Keep questions practical: palette/theme, mood, motion tone, and storytelling intensity. If speed matters, offer 2-3 options and recommend one, but do not hardcode black/dark as the default.

### C. Inspect every uploaded image asset
...
### D. Compositional planning  visual hierarchy before a single line of code
...
### E. Decide the cinematic role of each asset
